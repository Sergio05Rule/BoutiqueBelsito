...
const sendCreateOrderEmail = function(email, user, order) {
...
emaildata = emaildata + ",<\/p>\r\n                        <p>Ti ringraziamo per il tuo recente ordine sulle nostre pagine, di seguito i dettagli dell'ordine [n\u00B0";

// append order number
emaildata = emaildata + userOrder._id;
emaildata = emaildata + "]<\/p>\r\n                        <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" >\r\n                          <tbody>\r\n                            <tr>\r\n                              <td align=\"left\">\r\n                                <table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n                                  <tbody>\r\n ";

for (var i = 0; i < userOrder.orderItems.length ; i++)
{
  //open new <tr>
  emaildata = emaildata + "<tr>";

  emaildata = emaildata + "<td> <a href=\"https://www.boutiquebelsito.com/product/"+userOrder.orderItems[i].product+"/\"  target=\"_blank\">"+userOrder.orderItems[i].name+"<\/a> <\/td>";
...
var params = {
  ...
  Message: { /* required */
    Body: { /* required */
     ...
     Subject: {
      Charset: 'UTF-8',
      Data: emailReciverName + ' , grazie per il tuo ordine [n° '+ userOrder._id +']'
     }
    },
...
export default sendCreateOrderEmail;
