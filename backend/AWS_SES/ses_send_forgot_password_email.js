...
const sendForgotPasswordEmail = function(user, newPassword) {
...
var params = {
  ...
  Message: { /* required */
    Body: { /* required */
     ...
     Subject: {
      Charset: 'UTF-8',
      Data: userInfo.name + ' , reset della Password avvenuto con successo!'
     }
    },
